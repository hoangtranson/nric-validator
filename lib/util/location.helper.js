...
(function (LOCATION) {
    ...
    var isMalaysia = function (code) {
        return numisBetween(code, 1, 16) || numisBetween(code, 21, 59) || code == 82;
    };
    var isForeign = function (code) {
        var _country = Object.keys(COUNTRIES).find(function (_code) { return _code == "" + code; });
        return _country ? true : false;
    };
    var numisBetween = function (num, lower, upper) {
        return (num - lower) * (num - upper) <= 0;
    };
    LOCATION.isStateValid = function (code) {
